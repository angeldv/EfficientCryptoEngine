// test/test_efficientCryptoEngine.js
/**
 * Unit tests for EfficientCryptoEngine
 */

const assert = require('assert');
const { EfficientCryptoEngine } = require('../src/main');
const fs = require('fs').promises;
const path = require('path');

describe('EfficientCryptoEngine', function() {
    this.timeout(5000);
