// src/main.js
/**
 * Main entry point for EfficientCryptoEngine application
 */
...
class EfficientCryptoEngine {
    /**
     * Create a new EfficientCryptoEngine instance
...
module.exports = EfficientCryptoEngine;
...
if (require.main === module) {
    ...
    const app = new EfficientCryptoEngine({
        input: args.input,
        output: args.output,
